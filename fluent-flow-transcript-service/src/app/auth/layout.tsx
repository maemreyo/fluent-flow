  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      <div className="absolute inset-0 hidden overflow-hidden xl:block">
        ...
        <motion.div
          className="z-15 absolute inset-0"
          style={{
            background: `
        ...
        {/* Nebula Smoke Effect */}
        <motion.div
          className="z-8 absolute inset-0 opacity-20"
          style={{
            background: `
      ...
      {/* Content Container */}
      <div className="z-1000 relative mx-auto flex min-h-screen w-full max-w-[1600px]">
        {/* Left spacer for desktop */}
        <div className="hidden flex-1 xl:block" />

        {/* Right side - Form */}
        <div className="flex w-full flex-shrink-0 items-center justify-center bg-gray-50/80 p-8 backdrop-blur-sm xl:w-[580px] xl:max-w-[40vw] xl:bg-gray-50/80">
